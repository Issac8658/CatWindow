...
public static class WindowExStyles // Because of mouse paththrough doesnt work correctly on windows :P
{
	...
	public static void UpdateWindowsExStyles(Window window, bool HideTaskbarIcon, bool ForceWindowUpdate = true)
	{
